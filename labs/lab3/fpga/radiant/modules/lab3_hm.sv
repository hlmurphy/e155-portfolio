...
// Purpose: Top-level module for Lab 3, instantiates every submodule and wires them together
// -------------------------------------------------------------
module lab3_hm #(parameter display_max = 23_999,
                ...
                input logic         reset,      // active-low external reset button 
                input logic [3:0]   cols,       // async active low from keypad 
                output logic [3:0]  rows,       // one-hot row to keypad
                output logic [3:0]  col_leds,   // confirmation LED's
                output logic [6:0]  seg,        // active-low seven-segment combination
                output logic        anode_0, 
                output logic        anode_1);
        
        // Internal wire declarations
        logic reset_inv; // inverted reset
        logic reset_synced; // reset after 2 FF
