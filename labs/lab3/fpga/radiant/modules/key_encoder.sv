...
module key_encoder(input  logic [3:0]   row_active,
                ...
                always_comb
                    ...
                    // Row 0 & Columns 0-3 (R0+C0, R0+C1, R0+C2, ...)
                        8'b1000_1000: key_value = 4'h1;
                        8'b1000_0100: key_value = 4'h2;
                        8'b1000_0010: key_value = 4'h3;
                        8'b1000_0001: key_value = 4'hA;
                    // Row 1 & Columns 0-3
                        8'b0100_1000: key_value = 4'h4;
                        8'b0100_0100: key_value = 4'h5;
                        8'b0100_0010: key_value = 4'h6;
                        8'b0100_0001: key_value = 4'hB;
                    // Row 2 & Columns 0-3
                        8'b0010_1000: key_value = 4'h7;
                        8'b0010_0100: key_value = 4'h8;
                        8'b0010_0010: key_value = 4'h9;
                        8'b0010_0001: key_value = 4'hC;
                    // Row 3 & Columns 0-3
                        8'b0001_1000: key_value = 4'hE;
                        8'b0001_0100: key_value = 4'h0;
                        8'b0001_0010: key_value = 4'hF;
                        8'b0001_0001: key_value = 4'hD;
