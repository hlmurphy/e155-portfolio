...
The source code for the project can be found in the '/labs/lab1/fpga/radiant project' directory in the associated GitHub repository.

### Block Diagram
![RTL connections inside the top level module 'lab1_hm' (indicaiting expected relationship between modules)](images/block_diagram.jpeg){#fig-block width=80%}
...
![7-segment display wiring, showing common anode to +3.3 V and each cathode via a 150 Ω current-limiting resistor to its assigned FPGA GPIO pin (highlighted in purple).](images/schematic.jpeg){#fig-schematic width=80%}
...
![Decoder waveform with input data ranging from 0x0 through 0xF, segments outputs match expected patterns.](images/screenshots/seven_seg_module_waveforms.png){#fig-decoder-wave}
