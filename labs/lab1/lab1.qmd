...
![Clock cycle calculation - since HSOSC runs at 48 MHz and we want a 2.4 Hz output, we as 4.8 cycles per blink thus the MAX number of clock signals per cycle can only be 9,999,999.](images/clock_calcs.png){#fig-clock-calcs width="60%"}
...
![Displaying a 0 in hex given a input of 4'b0](images/onboard_2.jpeg){#fig-onboard width=50%}
...
### Reflection
Upon prompting Claude it quickly spit out some verilog code that I found hard to comprehend. Both the syntax and structues of the module it generated were so different that what ive seen in class or in E85 in previous years. So much that even if a synthesis error would up i would little idea as to what the error was speaking let alone why is occured. 

That being said I did find it helpful to ask claude specific questions about snippets of code to gain a better understanding of what was actually going on. I also found that it very helpful in the context it would bringup for expalining why a error was occuring and giving a course of actions on how to fix it. With that I found it to be more useful in the debuging process that the actual code generation however, there is an obvious danger of going down unnecessary rabbit holes making it more of a risk of being a time sink than saver.
